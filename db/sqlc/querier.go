...
type Querier interface {
	...
	UpdateEntryBalance(ctx context.Context, arg UpdateEntryBalanceParams) (Entry, error)
	UpdateTransferBalance(ctx context.Context, arg UpdateTransferBalanceParams) (Transfer, error)
}
